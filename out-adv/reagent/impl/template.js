...
reagent.impl.template.attr_aliases = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$37,"className",cljs.core.constant$keyword$49,"htmlFor",cljs.core.constant$keyword$50,"charSet"], null);
...
while (G__16853__i < G__16853__a.length) {G__16853__a[G__16853__i] = arguments[G__16853__i + 0]; ++G__16853__i;}
  args = new cljs.core.IndexedSeq(G__16853__a,0);
} 
...
var or__3772__auto__ = (function (){var G__16858 = n;
return (reagent.impl.template.attr_aliases.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.attr_aliases.cljs$core$IFn$_invoke$arity$1(G__16858) : reagent.impl.template.attr_aliases.call(null,G__16858));
})();
...
var G__16861 = o;
(G__16861[(function (){var G__16862 = k;
return (reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1(G__16862) : reagent.impl.template.cached_prop_name.call(null,G__16862));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__16863){
var vec__16865 = p__16863;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16865,(0),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16865,(1),null);
var pid = (props["id"]);
...
var pname_16868 = (function (){var G__16867 = k;
return (reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_prop_name.cljs$core$IFn$_invoke$arity$1(G__16867) : reagent.impl.template.cached_prop_name.call(null,G__16867));
})();
if(!((pname_16868 === "key"))){
(o[pname_16868] = reagent.impl.template.convert_prop_value(v));
} else {
}
...
var res = (function (){var G__16870 = e;
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__16870) : on_change.call(null,G__16870));
})();
...
var G__16873 = jsprops;
(G__16873["defaultValue"] = value);

(G__16873["value"] = null);

(G__16873["onChange"] = ((function (G__16873,on_change,value){
return (function (p1__16871_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__16871_SHARP_);
});})(G__16873,on_change,value))
);
...
var jsargs = (function (){var G__16879 = argv;
var G__16880 = ((hasprops)?(2):(1));
var G__16881 = ((inprops["level"]) + (1));
return (reagent.impl.template.convert_args.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.convert_args.cljs$core$IFn$_invoke$arity$3(G__16879,G__16880,G__16881) : reagent.impl.template.convert_args.call(null,G__16879,G__16880,G__16881));
})();
var jsprops = reagent.impl.template.convert_props(((hasprops)?props:null),id_class);
if((input_setup == null)){
} else {
var G__16882_16884 = this$;
var G__16883_16885 = jsprops;
(input_setup.cljs$core$IFn$_invoke$arity$2 ? input_setup.cljs$core$IFn$_invoke$arity$2(G__16882_16884,G__16883_16885) : input_setup.call(null,G__16882_16884,G__16883_16885));
}
...
var G__16887 = spec;
(G__16887["componentDidUpdate"] = ((function (G__16887){
return (function (){
var c = this;
...
(G__16887["componentWillUnmount"] = ((function (G__16887){
return (function (){
var c = this;
...
var C = this;
return reagent.impl.template.wrapped_should_update(C,p1__16888_SHARP_,p2__16889_SHARP_);
...
var vec__16891 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16891,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16891,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16891,(2),null);
...
var vec__16893 = reagent.impl.template.parse_tag(tag);
var comp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16893,(0),null);
var id_class = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16893,(1),null);
...
var withrender = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(spec,cljs.core.constant$keyword$51,f);
var res = (function (){var G__16895 = withrender;
return (reagent.impl.template.create_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.create_class.cljs$core$IFn$_invoke$arity$1(G__16895) : reagent.impl.template.create_class.call(null,G__16895));
})();
...
var G__16897 = tag;
return (reagent.impl.template.cached_wrapper.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.cached_wrapper.cljs$core$IFn$_invoke$arity$1(G__16897) : reagent.impl.template.cached_wrapper.call(null,G__16897));
} else {
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(x,cljs.core.constant$keyword$52);
} else {
return null;
}
});
...
var k_16900 = reagent.impl.template.get_key(cljs.core.meta(v));
var k_SINGLEQUOTE__16901 = (((k_16900 == null))?reagent.impl.template.get_key(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(1),null)):k_16900);
if((k_SINGLEQUOTE__16901 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__16901);
}

var G__16899 = jsprops;
return (c.cljs$core$IFn$_invoke$arity$1 ? c.cljs$core$IFn$_invoke$arity$1(G__16899) : c.call(null,G__16899));
});
...
var G__16908 = x;
var G__16909 = level;
return (reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2 ? reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2(G__16908,G__16909) : reagent.impl.template.expand_seq.call(null,G__16908,G__16909));
} else {
var s = reagent.ratom.capture_derefed((function (){
var G__16910 = x;
var G__16911 = level;
return (reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2 ? reagent.impl.template.expand_seq.cljs$core$IFn$_invoke$arity$2(G__16910,G__16911) : reagent.impl.template.expand_seq.call(null,G__16910,G__16911));
}),reagent.impl.template.seq_ctx);
...
var n__4659__auto___16912 = a.length;
var i_16913 = (0);
while(true){
if((i_16913 < n__4659__auto___16912)){
(a[i_16913] = reagent.impl.template.as_component.cljs$core$IFn$_invoke$arity$2((a[i_16913]),level_SINGLEQUOTE_));
